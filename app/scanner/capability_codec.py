...
_STANDARD_CAPABILITIES: dict[int, tuple[str, str, str]] = {
    ...
    ICAP_ORIENTATION: ("ICAP_ORIENTATION", "方向", "图像方向"),
    ICAP_FRAMES: ("ICAP_FRAMES", "图像区域", "图像采集区域"),
    ICAP_XRESOLUTION: ("ICAP_XRESOLUTION", "水平分辨率", "图像水平分辨率"),
    ICAP_YRESOLUTION: ("ICAP_YRESOLUTION", "垂直分辨率", "图像垂直分辨率"),
    ICAP_BITDEPTH: ("ICAP_BITDEPTH", "位深度", "每像素的位数"),
    ICAP_SUPPORTEDSIZES: ("ICAP_SUPPORTEDSIZES", "支持的纸张尺寸", "设备支持的纸张尺寸"),
    ICAP_JPEGQUALITY: ("ICAP_JPEGQUALITY", "JPEG质量", "JPEG图像质量"),
}
